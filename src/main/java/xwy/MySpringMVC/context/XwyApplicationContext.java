package xwy.MySpringMVC.context;
...
public class XwyApplicationContext {
	...
	public XwyApplicationContext(String location){
	...
	private void doCreateBean(){
		...
		try{
			...
			for (String className : classCache) {
				...
				}else if(clazz.isAnnotationPresent(XwyService.class)){
					
					XwyService service = clazz.getAnnotation(XwyService.class);
	...
	private void populate(){
		...
		for (Entry<String, Object> entry : instanceMapping.entrySet()) {
			...
			for (Field field : fields) {
				...
				if(!field.isAnnotationPresent(XwyAutowired.class)){ continue; }
